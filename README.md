...
- [x] Installing Ubuntu 
  ...
  - [x] Dell Precision 5530 tweaks for Ubuntu
    - [x] Respin image
  - [ ] Installing necessary software packages **(This should be moved to an install script)**
...
IF you don't like to use the tool there is still an option to donload the iso file directly, all you need to do is make MS servers think you're using an unsupported OS. 
...
Drivers:
- [DisplayLink driver](https://www.displaylink.com/downloads/ubuntu) - I have a DisplayLink dock at work, hence this is a must for me.
